...
### Negative Number Bonus
- ✅ +1 bonus spacebuck for problems with negative numbers
- ✅ Works with negative input1 or input2
- ✅ Works with both inputs negative
- ✅ No bonus for positive numbers or zero
...
| Operation | Numbers | Super Streak | Expected Reward |
|-----------|---------|--------------|-----------------|
| Addition | 5 + 3 | No | 1 spacebuck |
| Addition | -2 + 5 | No | 2 spacebucks (1 + 1 bonus) |
| Subtraction | 8 - 3 | No | 2 spacebucks |
| Subtraction | 5 - (-2) | No | 3 spacebucks (2 + 1 bonus) |
| Multiplication | 4 × 6 | No | 3 spacebucks |
| Multiplication | -3 × 4 | No | 4 spacebucks (3 + 1 bonus) |
| Multiplication | -3 × 4 | Yes | 8 spacebucks ((3 + 1) × 2) |
